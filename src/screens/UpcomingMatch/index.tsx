...
type Props = HomeStackScreenProps<'UpcomingMatch'>;

const UpcomingMatch = ({ navigation }: Props) => {
  return (
      ...
      <ScrollView>
        <VStack>
          <HStack>
            ...
            <View>
              <Text style={S.playerName}>Upcoming Match </Text>
            </View>
          </HStack>
          <TouchableOpacity>
            <HStack margin={5}>
